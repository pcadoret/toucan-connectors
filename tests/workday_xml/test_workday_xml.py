...
def data_source():
	...
	operations= [{"xpath": ".//wd:Date_de_l_absence", "attribute": None, "column": "Date_Absence"}],
    	report_url= 'https://wd3-impl-services1.workday.com/ccx/service/systemreport2/umanis/All_Worker_Time_Off?Inclure_les_responsables=0&Inclure_les_organisations_subordonn%C3%A9es=1',
    )
